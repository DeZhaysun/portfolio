      ...
      <main className="content">
        ...
        <section id="experience" className="experience">
          <div className="section-header">
            ...
            <p className="section-subtitle">A timeline of roles where I shipped impactful product and infrastructure work.</p>
          </div>
          <div className="timeline-horizontal">
            <article className="timeline-logo" tabIndex="0">
              ...
              <div className="timeline-details">
                <p className="timeline-role">Software Engineer Intern • Seattle, WA</p>
                <p className="timeline-blurb">Built Android Messenger experiences at massive scale. Focused on engagement and content creation workflows.</p>
              </div>
            </article>
            ...
            <article className="timeline-logo" tabIndex="0">
              ...
              <div className="timeline-details">
                <p className="timeline-role">Software Developer Intern • Toronto, ON</p>
                <p className="timeline-blurb">Delivered data-driven optimization and ML-assisted pipelines for grocery retail. Improved assortment planning and product coverage.</p>
              </div>
            </article>
            ...
            <article className="timeline-logo" tabIndex="0">
              ...
              <div className="timeline-details">
                <p className="timeline-role">Software Developer Intern • Waterloo, ON</p>
                <p className="timeline-blurb">Accelerated graphics validation and tooling through automation. Reduced migration and verification timelines.</p>
              </div>
            </article>
            ...
            <article className="timeline-logo" tabIndex="0">
              ...
              <div className="timeline-details">
                <p className="timeline-role">Software Developer Intern • Kanata, ON</p>
                <p className="timeline-blurb">Built automation and tooling to streamline credential workflows. Improved demo operations and analysis tasks.</p>
              </div>
            </article>
            ...
            <article className="timeline-logo" tabIndex="0">
              ...
              <div className="timeline-details">
                <p className="timeline-role">Software Developer Intern • Ottawa, ON</p>
                <p className="timeline-blurb">Delivered a full-stack metrics platform for engineering orgs. Improved data pipelines and reporting speed.</p>
              </div>
            </article>
            ...
            <article className="timeline-logo" tabIndex="0">
              ...
              <div className="timeline-details">
                <p className="timeline-role">Software QA Analyst • Toronto, ON</p>
                <p className="timeline-blurb">Led QA strategy and automation for an educational platform. Improved release quality and test coverage.</p>
              </div>
            </article>
          </div>
        </section>
        <section id="portfolio" className="portfolio">
          <div className="section-header">
            ...
            <p className="section-subtitle">A curated set of projects spanning full-stack, ML, and product engineering.</p>
          </div>
